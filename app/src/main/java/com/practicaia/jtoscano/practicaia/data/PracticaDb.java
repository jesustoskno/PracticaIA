...
public class PracticaDb extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        final String SQL_CREA_TABLA_CIUDADES = "CREATE TABLE IF NOT EXISTS " + Contrato.ContratoCiudades.TABLE_NAME + " (" +
                Contrato.ContratoCiudades.ID + " INTEGER PRIMARY KEY, " +
                Contrato.ContratoCiudades.ESTADO + " TEXT NOT NULL, " +
                Contrato.ContratoCiudades.ID_ESTADO + " INTEGER NOT NULL, " +
                Contrato.ContratoCiudades.ID_PAIS + " INTEGER NOT NULL, " +
                ...
                " );";
        final String SQL_CREA_TABLA_COMPLEJOS = "CREATE TABLE IF NOT EXISTS " + Contrato.ContratoComplejos.TABLE_NAME + " ("+
                Contrato.ContratoComplejos.ID + " INTEGER PRIMARY KEY, " +
                Contrato.ContratoComplejos.IDCIUDAD + " INTEGER NOT NULL, " +
                Contrato.ContratoComplejos.DIRECCION + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.ES_COMPRA + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.LATITUD + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.LONGITUD + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.NOMBRE + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.TELEFONO + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.IDESTADO + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.IDVISTA + " TEXT NOT NULL, " +
                Contrato.ContratoComplejos.URL + " TEXT NOT NULL "+/*+
                " FOREIGN KEY (" + Contrato.ContratoCiudades.ID + ") REFERENCES " +
                Contrato.ContratoComplejos.IDCIUDAD +
                */" );";
